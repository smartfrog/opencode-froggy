...
- Use `unknown` for untrusted data, then validate or narrow.
...
### Hooks and config parsing

- Hooks are defined in `hook/hooks.md` frontmatter.
- When adding new hook events, update both `VALID_HOOK_EVENTS` and docs.
